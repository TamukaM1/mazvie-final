...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($vehicle_name)) {
        ...
        $sql = "INSERT INTO Vehicles (vehicle_name) VALUES ('$vehicle_name')";
                ...
                <?php if (isAdmin()) { ?>
                    ...
                    <li class="menu-item">
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a
                                    href="<?php echo htmlspecialchars('view_locations.php'); ?>"
                                    class="menu-link"
                                    target="_blank">
                                    <div data-i18n="Landing">View Location</div>
                                </a>
                            </li>
                        </ul>
                    </li>
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="py-3 mb-4"><span class="text-muted fw-light">Location /</span> View Locations</h4>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form method="post" action="">
                                            <div class="modal-body">
                                                ...
                                                <div class="row">
                                                    <div class="col mb-3">
                                                        <label for="nameWithTitle" class="form-label">Vehicle Number Plate</label>
                                                        <input
                                                            type="text"
                                                            id="nameWithTitle"
                                                            class="form-control"
                            ...
                            <table class="table table-hover">
                                ...
                                <?php foreach ($result as $row): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="edit_vehicle.php?vehicle_id=<?= $row['vehicle_id'] ?>">Edit</a> |
                                            <a href="delete_vehicle.php?vehicle_id=<?= $row['vehicle_id'] ?>" onclick="return confirm('Are you sure you want to delete this vehicle?');">Delete</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                                </tbody>
